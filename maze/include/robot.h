...
{
public:
    Robot(const Maze& maze, float x, float y, float theta, float wheelBase, float speed, float kp, float ki, float kd, float targetTheta);
    ...
    void turnToGoalOrientation(float dt); // Function to turn the robot to the target orientation
