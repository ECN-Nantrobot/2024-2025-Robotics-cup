...
int main(int argc, char** argv)
{
    ...
    // msg.linear.x  = robot.getLinearVelocity();  // Replace with your velocity computation
    // msg.angular.z = robot.getAngularVelocity(); // Replace with your rotation computation
    msg.linear.x  = 0.1;  // Replace with your velocity computation
    msg.angular.z = 0.5; // Replace with your rotation computation
